...
stateId:any;
  ...
  companyProfileForm = this.fb.group({
    ...
    company_registration_number:['', [Validators.required, Validators.pattern('^[0-9, ]*$')]], 
    company_logo:[''],  
    company_registered_address1:['',Validators.required],
    company_registered_address2:['', [Validators.required, Validators.pattern('^[a-zA-Z, ]*$')]], 
    company_registered_address3:['', [Validators.required, Validators.pattern('^[a-zA-Z, ]*$')]],   
    ...
    alternative_contact_no:['',[Validators.required,Validators.pattern('[6-9]{1}[0-9]{9}'),Validators.maxLength(10),Validators.minLength(10)]],
